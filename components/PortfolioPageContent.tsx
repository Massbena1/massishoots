...
const FEATURED = [
  {
    ...
    caseStudy: {
      defi: "[DÉFI — ex: Le client avait besoin de 200 photos livrées en 24h pour un gala de 500 personnes]",
      livre: "[LIVRÉ — ex: Couverture complète photo + vidéo highlight 2 min]",
      resultat: "[RÉSULTAT — ex: +2 500 vues sur LinkedIn en 48h]",
    },
    testimonial: {
      quote: "[TÉMOIGNAGE CLIENT — ex: \"Massi a capturé exactement l'ambiance qu'on voulait transmettre. Résultat au-delà de nos attentes.\"]",
      name: "[NOM CLIENT]",
  ...
  },
  {
    ...
    caseStudy: {
      defi: "[DÉFI — ex: Profil Instagram stagnant à 800 abonnés, contenu irrégulier et peu engageant]",
      livre: "[LIVRÉ — ex: 30 photos pro + 8 Reels + 4 vidéos face caméra en un mois]",
      resultat: "[RÉSULTAT — ex: +1 200 abonnés et 3 contrats signés via Instagram en 60 jours]",
    },
    testimonial: {
      quote: "[TÉMOIGNAGE CLIENT — ex: \"Depuis qu'on travaille avec Massishoots, mes clients me disent qu'ils me reconnaissent partout.\"]",
      name: "[NOM CLIENT]",
      role: "[RÔLE, ENTREPRISE]",
    },
  },
  {
    ...
    caseStudy: {
      defi: "[DÉFI — ex: Cérémonie extérieure avec lumière changeante, 180 invités, programme serré]",
      livre: "[LIVRÉ — ex: Album 350 photos + film highlights 4 min + teaser 60s Instagram]",
      resultat: "[RÉSULTAT — ex: Partagé par 40+ invités sur Instagram, 12 000 impressions organiques]",
    },
    testimonial: {
      quote: "[TÉMOIGNAGE CLIENT — ex: \"On a regardé notre film de mariage au moins 20 fois. C'est exactement ce qu'on ressentait ce jour-là.\"]",
      name: "[NOM CLIENT]",
      role: "[Mariés — Ville]",
    },
  },
