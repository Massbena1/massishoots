...
export async function POST(req: NextRequest) {
  try {
    ...
    await resend.emails.send({
      ...
      subject: `🔥 Nouveau lead chatbot — ${service}`,
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a0a; color: #fff; padding: 32px; border-radius: 12px;">
          <div style="border-left: 3px solid #C9A84C; padding-left: 16px; margin-bottom: 24px;">
            <h2 style="color: #C9A84C; margin: 0 0 4px;">Nouveau lead via le chatbot</h2>
          ...
          <table style="width: 100%; border-collapse: collapse;">
            <tr>
              ...
              <td style="padding: 12px 0; border-bottom: 1px solid rgba(255,255,255,0.08); color: #fff; font-weight: 600;">${name}</td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="padding: 12px 0; color: rgba(255,255,255,0.5); font-size: 12px; text-transform: uppercase; letter-spacing: 0.1em;">Intérêt</td>
